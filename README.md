...
I build things across the stack — quantum algorithms, cross-platform apps, ML research, and web tools. Most of my work lives at the intersection of academic research and practical software.
...
**Languages:** C#, Kotlin, Python, Java, TypeScript, JavaScript  
**Frameworks:** .NET MAUI, Compose Multiplatform, React, Next.js, Avalonia  
**ML/Quantum:** PyTorch, Qiskit, scikit-learn, timm  
**Backend:** Supabase (PostgreSQL, Auth, PostgREST), SQLite, MySQL  
**Tools:** MVVM, CommunityToolkit, Vite, DirectML, ML Kit, ZXing

---

## 📫 Reach me

- **Email** — [205175683+verycareful@users.noreply.github.com](mailto:205175683+verycareful@users.noreply.github.com)
